const traducoes = {
  pt: {
    ...
    leituraFalhou: "Não foi possível ler a MRZ. Escolha uma nova foto da galeria ou tire outra fotografia.",
  ...
  en: {
    ...
    leituraFalhou: "Could not read the MRZ. Choose a new photo from the gallery or take another photo.",
  ...
  fr: {
    ...
    leituraFalhou: "Impossible de lire la MRZ. Choisissez une nouvelle photo dans la galerie ou prenez une autre photo.",
  ...
  es: {
    ...
    leituraFalhou: "No se pudo leer la MRZ. Elige una nueva foto de la galería o toma otra fotografía.",
